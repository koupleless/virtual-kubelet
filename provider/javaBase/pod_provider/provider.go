...
var _ vnode.PodNotifier = &BaseProvider{}
...
func (b *BaseProvider) installBizMqtt(_ context.Context, bizModel *ark.BizModel) error {
	...
	b.mqttClient.Pub(utils.FormatArkletCommandTopic(b.nodeID, model.CommandInstallBiz), mqtt.Qos1, installBizRequestBytes)
	return nil
}
...
func (b *BaseProvider) unInstallBizMqtt(_ context.Context, bizModel *ark.BizModel) error {
	...
	b.mqttClient.Pub(utils.FormatArkletCommandTopic(b.nodeID, model.CommandUnInstallBiz), mqtt.Qos1, unInstallBizRequestBytes)
	return nil
}
