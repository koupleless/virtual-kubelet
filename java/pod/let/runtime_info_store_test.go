...
func TestRuntimeInfoStore_PutPod(t *testing.T) {
	podKey := runtimeInfoStore.modelUtils.GetPodKey(defaultPod)
...
func TestRuntimeInfoStore_GetPodByKey(t *testing.T) {
	podKey := runtimeInfoStore.modelUtils.GetPodKey(defaultPod)
	podKey2 := runtimeInfoStore.modelUtils.GetPodKey(defaultPod2)
...
func TestRuntimeInfoStore_GetRelatedBizModels(t *testing.T) {
	podKey1 := runtimeInfoStore.modelUtils.GetPodKey(defaultPod)
	podKey2 := runtimeInfoStore.modelUtils.GetPodKey(defaultPod2)
...
func TestRuntimeInfoStore_GetRelatedPodKeyByBizIdentity(t *testing.T) {
	podKey := runtimeInfoStore.GetRelatedPodKeyByBizIdentity(runtimeInfoStore.modelUtils.GetBizIdentityFromBizModel(&ark.BizModel{
